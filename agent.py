...
def run():
	...
	# Changed update_delay=2.0 to 0.01 to reduce the time between steps in each trial, 
	#log_metrics=False to True to save the results as CSV
	#display=True to False make the trials go faster
